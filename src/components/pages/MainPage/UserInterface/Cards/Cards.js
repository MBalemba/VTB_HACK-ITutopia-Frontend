...
import BanModal from "../Modals/BanModal/BanModal";
import TemporaryModal from "../Modals/TemporaryModal/TemporaryModal";
    ...
    return (
            <Cards>
                ...
                <Sliderblock>
                    ...
                    {userId && <SliderCards cardsInfoLength={cardsInfo.length} userId={userId} handleCurrentSlide={handleCurrentSlide} id={'mainpage_1'} render={() =>
                        <>
...
''
                            ...
                            <ButtonsControl>
                                ...
                                <Time onClick={()=>{ cardsInfo[currentSlide]?.status !=='BLOCKING' && setTempModal(true)}}>
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M10.031 5.625V5.55H9.95602H9H8.925V5.625V9.12262V9.14735L8.93971 9.16723L10.5138 11.2946L10.5741 11.3761L10.6344 11.2946L11.3103 10.3811L11.3433 10.3365L11.3103 10.2919L10.031 8.56297V5.625Z" fill="white" stroke="white" strokeWidth="0.15"/>
                                    </svg>
                                </Time>

                                <Blocker onClick={()=>setBanModal(true)}>
                ...
                <BanModal userId={userId} cardId={cardsInfo[currentSlide].id}  departamentName={departamentName} fio={fio} info={cardsInfo[currentSlide]} setActive={setBanModal} active={banModal}/>
                <TemporaryModal userId={userId} cardId={cardsInfo[currentSlide].id}  departamentName={departamentName} fio={fio} info={cardsInfo[currentSlide]} setActive={setTempModal} active={tempModal}/>
            </Cards>
    );
};
